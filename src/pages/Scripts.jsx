    ...
    <div className="space-y-6">
      ...
      {readingScript && (
        <Modal
          ...
          subtitle={`Client: ${readingScript.clientName} • Writer: ${readingScript.writer} • Creator: ${readingScript.creatorName} • Status: ${readingScript.status}`}
          maxWidth="max-w-2xl"
        >
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-stone-200">
              <span className="text-xs text-stone-500">Deadline: {readingScript.deadline}</span>
              <div className="flex items-center gap-2">
                <button
